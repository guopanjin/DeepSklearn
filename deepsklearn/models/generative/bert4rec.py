...
class Bert4Rec(nn.Module):
    def __init__(self,
        ...
        self.item_embedding_table = nn.Embedding(self.num_items + 2, self.embed_dim, padding_idx=0)
    ...
    def forward(self, x):
        ...
        item_embeddings = torch.transpose(self.item_embedding_table.weight, 0, 1)  # (embed_dim,num_items+2)
        logits = x @ item_embeddings  # (batch_size,seq_len,num_items+2)
        return logits
