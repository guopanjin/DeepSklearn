...
concat(embedding) + innter_product(embedding)--->MLP--logits
'''
class PNN(nn.Module):
    def __init__(self,
                 *,
        ...
        self.mlp_block=MLPBlock(
            input_dim=self.feature_size*self.embedding_size + (self.feature_size**2-self.feature_size)//2,
    ...
    def forward(self,x):
        ...
        mlp_input=torch.concat([dnn_input,inner_product_output],dim=-1)
